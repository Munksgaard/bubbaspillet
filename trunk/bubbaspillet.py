...
if __name__ == '__main__': 
	...
	while foobar:
		feedback = main()
		print "Antal drÃŠbte Brady'er: " + str(SCORE)
		print "Antal tastetryk: " + str(keypresses)
		print "Antal skud: " + str(total_shots)
		print "PrÃŠcisionen: " + str(100.*SCORE/total_shots)

                if int(current_highscore)<SCORE:
                        fil = open("highscore.txt", 'w')
                        fil.write(str(SCORE))
                        fil.close()
                        print "Du har slået rekorden! Den var på " + str(current_highscore) + " og du fik: " + str(SCORE)
